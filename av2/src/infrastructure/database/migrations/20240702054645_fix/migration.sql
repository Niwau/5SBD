...
INSERT INTO "new_Order" ("buyer_email", "buyer_name", "buyer_phone_number", "cpf", "id", "payments_date", "purchase_date", "ship_address_1", "ship_address_2", "ship_address_3", "ship_city", "ship_country", "ship_postal_code", "ship_state") SELECT "buyer_email", "buyer_name", "buyer_phone_number", "cpf", "id", "payments_date", "purchase_date", "ship_address_1", "ship_address_2", "ship_address_3", "ship_city", "ship_country", "ship_postal_code", "ship_state" FROM "Order";
DROP TABLE "Order";
